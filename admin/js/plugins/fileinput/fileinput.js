...
!function (e) {
    ...
    var t, i, a = function () {
        var e = document.currentScript.src, t = e.substring(0, e.lastIndexOf("/"));
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
                ...
                i = a.resumableManager = {
                    init: function (e, t, n) {
                        ...
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            if (s > r.maxRetries) return v(m.resumableMaxRetriesReached, {n: r.maxRetries}), void i.setProcessed("error");
                            var h, w, b, _, C, x,
                            ...
                            h = new FormData, d = o.stack[u], a._setUploadData(h, {
                                ...
                                return a._isAborted() ? void v(m.resumableAborting) : (w = a._getOutData(h, t), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, s, o, i, w]), i.pushAjax(e, s + 1), void v(m.resumableRetryError, {n: s - 1}))
                            }, x = function () {
            ...
            var i, a, r, n, o, s, l, d, c, u, p, f, m, g, v, h, w, b, _, C, x, y, T, P, k, F, S, E, I, A, D, z, j, $, U,
                M, R, B, O, L, N, Z, H, W = this, V = function (e, i) {
            ...
            i.previewCache = {
                data: {}, init: function () {
                    ...
                    var o, s = n.config[e], l = t.ifSet("caption", s), d = t.ifSet("width", s, "auto"),
                        ...
                        v = s.downloadUrl || g, h = s.filename || s.caption || "", w = !!v,
            ...
            y && (y = decodeURIComponent(y), g = w.html().replace(t.ZOOM_VAR, "").setTokens({zoomData: y}), w.html(g), i.data("zoom", ""), w.attr("data-zoom", y)), n = w.attr("data-template") || "generic", r = w.find(".kv-file-content"), o = r.length ? '<span class="kv-spacer"></span>\n' + r.html() : "", f = i.data("caption") || v.msgZoomModalHeading, m = i.data("size") || "", u = i.data("description") || "", b.find(".kv-zoom-caption").attr("title", f).html(f), b.find(".kv-zoom-size").html(m), p = b.find(".kv-zoom-description").hide(), u && (v.showDescriptionClose && (u = v._getLayoutTemplate("descriptionClose").setTokens({closeIcon: v.previewZoomButtonIcons.close}) + "</button>" + u), p.show().html(u), v.showDescriptionClose && v._handler(b.find(".kv-desc-hide"), "click", function () {
                ...
                var e, t = b.find(".modal-header"), i = b.find(".floating-buttons"), a = t.find(".kv-zoom-actions"),
                    r = function (e) {
                        var i = v.$modal.find(".kv-zoom-body"), a = v.zoomModalHeight;
                ...
                var i, a, r = t.which || t.keyCode, n = v.processDelay + 1, o = e(this).find(".btn-kv-prev"),
                    s = e(this).find(".btn-kv-next"), l = e(this).data("previewId");
                [i, a] = v.rtl ? [39, 37] : [37, 39], e.each({prev: [o, i], next: [s, a]}, function (e, t) {
                    var i = t[0], a = t[1];
            ...
            e && e.length && (t.initModal(a), t.setHtml(a, i._getModalContent()), i._setZoomContent(e), a.data({backdrop: !1}), a.modal("show"), i._initZoomButtons())
            ...
            var n, o, s, l, d, c, u, p, f, m, g, v, h, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
                x = w._getThumbId(a), y = _ > 0 || !e.isEmptyObject(w.uploadExtraData),
                T = w.ajaxOperations.uploadThumb, P = b.getFile(a), k = {id: x, index: i, fileId: a},
            ...
            }, w._setFileData(C, P.file, F, a), w._setUploadData(C, {fileId: a}), w._ajaxSubmit(p, m, g, v, C, a, i)))
            ...
            i._initZoomButton(), a.find(n).each(function () {
                ...
                if (!t.isEmpty(p) && void 0 !== f) {
                    ...
                    var g, v, h, w, b, _ = u.closest(t.FRAMES), C = i.previewCache.data, x = _.attr("data-fileindex");
            ...
            return h = 400 > y ? b.previewSettingsSmall[I] || b.defaults.previewSettingsSmall[I] : b.previewSettings[I] || b.defaults.previewSettings[I], h && e.each(h, function (e, t) {
                ...
                var v, h = d ? "zoom-" + o : o, w = b._getPreviewTemplate(a), C = (c || "") + " " + u;
            ...
            }, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(E ? "other" : i, a, !0, "kv-zoom-thumb", g)), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), v = w(S ? "other" : i, a, !1, "kv-preview-thumb", g), v.setTokens({zoomCache: C})
            ...
            if (n.showPreview || o && o.length) {
                ...
                if (n.enableResumableUpload) {
                    var m, g = r.loaded, v = d.getUploadedSize(), h = d.file.size;
            ...
            c && u || (l = "load.fileinputimageorient", f ? (i = a, a = null, i.css(d.previewSettings.image), s = e(document.createElement("div")).appendTo(n.find(".kv-file-content")), o = e(document.createElement("span")).insertBefore(i), i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(s)) : p = !i.is(":visible"), i.off(l).on(l, function () {
                ...
                var g = Math.atan(u / c), v = Math.sqrt(Math.pow(c, 2) + Math.pow(u, 2)),
                    h = v ? c / Math.cos(Math.PI / 2 + g) / v : 1, w = " scale(" + Math.abs(h) + ")";
            ...
            var o, s, l, d, c, u, p, f, m, g, v = this, h = e(a.img)[0], w = h.naturalWidth, b = h.naturalHeight, _ = 1,
                C = v.maxImageWidth || w, x = v.maxImageHeight || b, y = !(!w || !b), T = v.imageCanvas,
                P = v.imageCanvasContext, k = a.typ, F = a.pid, S = a.ind, E = a.thumb, I = a.exifObj;
            if (c = function (e, t, i) {
            ...
            var f, m = s === !1 ? "" : ' data-url="' + s + '"', g = "", v = "",
                h = l === !1 ? "" : ' data-key="' + l + '"', w = "", b = "", _ = "",
            ...
            return a && (w = p._getLayoutTemplate("actionDelete").setTokens({
                ...
                dragIcon: x.dragIcon
            })), C.setTokens({"delete": w, upload: b, download: _, zoom: g, drag: v, other: y})
        }, _browse: function (e) {
            var t = this;
            ...
            if (e(document.body).off("focusin.fileinput focusout.fileinput"), !a.changeTriggered) {
                ...
                var r, n, o, s, l = a.$element, d = arguments.length > 1, c = a.isAjaxUpload,
                    ...
                    m = !c && f ? 1 : a.maxFileCount, g = a.maxTotalFileCount, v = g > 0 && g > m, h = f && p > 0,
                    w = function (t, i, r, n) {
            ...
            var a, r = this, n = r.reader, o = r.$previewContainer, s = r.$previewStatus, l = r.msgLoading,
                ...
                m = f ? f.length : 0, g = r.allowedFileExtensions, v = t.isEmpty(g) ? "" : g.join(", "),
            ...
            }), r.reset(), i._raise("fileuploadcancelled", [i.fileManager, r])) : i._raise("fileuploadcancelled", [i.fileManager]), i._initAjax(), s > 0) for (t = 0; s > t; t += 1) i.cancelling = !0, a[t].abort();
            return i._getThumbs().each(function () {
            ...
            var i, a, r = this, n = r.fileManager, o = n.count(), s = !e.isEmptyObject(r._getExtraData());
    ...
    var r = 'class="kv-preview-data file-preview-pdf" src="{renderer}?file={data}" {style}',
        n = "btn btn-sm btn-kv " + t.defaultButtonCss(), o = "btn " + t.defaultButtonCss();
    e.fn.fileinput.defaults = {
        ...
        msgNo: "No",
        msgNoFilesSelected: "Ningún archivo seleccionado",
        msgCancelled: "Cancelado",
        msgPaused: "Paused",
        msgPlaceholder: "Seleccciona {files} ...",
        ...
        msgFilesTooLess: "Debe seleccionar al menos <b>{n}</b> {files} subir.",
        msgFilesTooMany: "Número de archivos seleccionados para subir <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>.",
        msgTotalFilesTooMany: "Puedes subir un máximo de <b>{m}</b> archivos (<b>{n}</b> archivos detectados).",
        ...
        msgFilePreviewAborted: 'Vista previa del archivo anulada para "{name}".',
        ...
        msgInvalidFileType: 'Tipo de archivo no válido "{name}". Solo "{types}" son compatibles.',
        msgInvalidFileExtension: 'Extensión no válida para el archivo "{name}". solo "{extensions}" son compatibles.',
        msgFileTypes: {
            image: "image",
            html: "HTML",
            text: "text",
        ...
        dropZoneTitle: "Arrastra elementos aquí",
